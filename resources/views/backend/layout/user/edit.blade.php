    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit Lecturer</h4>
                        <div class="mt-4">
                            <form id="my-form" class="forms-sample" action="{{route('admin.lecturer.update',$data->id)}}" method="post"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" name="email" value="{{ $data->email ?? ''}}" placeholder="Email Here......">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
